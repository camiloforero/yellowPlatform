...
urlpatterns = [
    ...
    url(r'^(?i)(?P<office_name>\w+)/ranking/(?P<programa>([io]g(v|et|e|t))|total)/(?P<ranking>\w+)/(?P<metric>\w+)/$', cache_page(60)(views.GetRanking.as_view()), name='ranking'),#FIn de las vistas
