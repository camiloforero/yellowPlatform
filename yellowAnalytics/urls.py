...
urlpatterns = [
    ...
    url(r'^(?i)(?P<office_name>\w+)/scoreboard/(?P<programa>[io]g(v|et))/$', cache_page(60*1)(views.GetAreaScoreboard.as_view()), name='area_scoreboard'),
    url(r'^(?i)(?P<office_name>\w+)/ranking/$', cache_page(60)(views.GetRankingIndex.as_view()), name='ranking_index'),
    url(r'^(?i)(?P<office_name>\w+)/ranking/(?P<programa>([io]g(v|et))|total)/(?P<ranking>\w+)/(?P<metric>\w+)/$', cache_page(60)(views.GetRanking.as_view()), name='ranking'),#FIn de las vistas
    ...
    url(r'^(?i)(?P<programa>[io]g(v|et))/$', cache_page(60*1)(views.GetAreaScoreboard.as_view()), name='area_scoreboard2'),
